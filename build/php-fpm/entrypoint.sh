...
sed -i "s,^DATABASE_URL=,DATABASE_URL=mysql://${MYSQL_CREDENTIAL}symfony-starter-mysql:3306/${MYSQL_DATABASE}," './.env'
sed -i "s/^LOCALE=/LOCALE=ru_Ru/" './.env'
sed -i "s/^MYSQL_HOST=/MYSQL_HOST=symfony-starter-mysql/" './.env'
...
sed -i "s/^WORKSPACE_IP=/WORKSPACE_IP=symfony-starter-mysql/" './.env'
source ./.env
